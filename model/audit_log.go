...
const (
	...
	AuditIntegrationTokenCreate = "integration_token_create"
	AuditIntegrationTokenUpdate = "integration_token_update"
	AuditIntegrationTokenRevoke = "integration_token_revoke"
